...
export class CalcParser extends Parser {
                ...
                case 6:
                  {
                    ...
                    this.state = 31
                    ;(_localctx as ModuloContext)._right = this.expression(2)
                  }
                  break
              }
            }
  ...
  public static readonly _serializedATN: string =
    ...
    '\b\x02\x02\x1B#\x05\x04\x03\x06\x1C\x1D\f\x04\x02\x02\x1D\x1E\x07\t\x02' +
    '\x02\x1E#\x05\x04\x03\x05\x1F \f\x03\x02\x02 !\x07\n\x02\x02!#\x05\x04' +
