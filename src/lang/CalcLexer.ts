...
export class CalcLexer extends Lexer {
	...
	public static readonly ruleNames: string[] = [
		"T__0", "T__1", "POW", "MUL", "DIV", "ADD", "SUB", "MOD", "NUMBER", "WHITESPACE",
	];
	...
	public static readonly _serializedATN: string =
		...
		"\n\n\r\n\x0E\n.\x03\v\x06\v2\n\v\r\v\x0E\v3\x03\v\x03\v\x02\x02\x02\f" +
		"\x03\x02\x03\x05\x02\x04\x07\x02\x05\t\x02\x06\v\x02\x07\r\x02\b\x0F\x02" +
		"\t\x11\x02\n\x13\x02\v\x15\x02\f\x03\x02\x04\x03\x022;\x05\x02\v\f\x0F" +
		"\x0F\"\"\x028\x02\x03\x03\x02\x02\x02\x02\x05\x03\x02\x02\x02\x02\x07" +
		...
		"\x13,\x03\x02\x02\x02\x151\x03\x02\x02\x02\x17\x18\x07*\x02\x02\x18\x04" +
		"\x03\x02\x02\x02\x19\x1A\x07+\x02\x02\x1A\x06\x03\x02\x02\x02\x1B\x1C" +
		"\x07`\x02\x02\x1C\b\x03\x02\x02\x02\x1D\x1E\x07,\x02\x02\x1E\n\x03\x02" +
		"\x02\x02\x1F \x07f\x02\x02 !\x07k\x02\x02!\"\x07x\x02\x02\"\f\x03\x02" +
		"\x02\x02#$\x07-\x02\x02$\x0E\x03\x02\x02\x02%&\x07/\x02\x02&\x10\x03\x02" +
		"\x02\x02\'(\x07o\x02\x02()\x07q\x02\x02)*\x07f\x02\x02*\x12\x03\x02\x02" +
		"\x02+-\t\x02\x02\x02,+\x03\x02\x02\x02-.\x03\x02\x02\x02.,\x03\x02\x02" +
		"\x02./\x03\x02\x02\x02/\x14\x03\x02\x02\x0202\t\x03\x02\x0210\x03\x02" +
		"\x02\x0223\x03\x02\x02\x0231\x03\x02\x02\x0234\x03\x02\x02\x0245\x03\x02" +
		"\x02\x0256\b\v\x02\x026\x16\x03\x02\x02\x02\x05\x02.3\x03\b\x02\x02";
